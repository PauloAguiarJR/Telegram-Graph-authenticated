...
Por limitação da aplicação <code><i>“telegram-cli”</i></code>, ainda não é possível enviar mensagem para supergrupos, pois não houve atualização depois desta novidade
